package com.upc.ReservaRecursos.Seguridad;

import com.upc.ReservaRecursos.Negocio.IUsuarioNegocio;
import com.upc.ReservaRecursos.Seguridad.JWT.JwtEntryPoint;
import com.upc.ReservaRecursos.Seguridad.JWT.JwtTokenFilter;
...
public class MainSeguridad extends WebSecurityConfigurerAdapter {
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(usuarioNegocio).passwordEncoder(passwordEncoder());
    }
